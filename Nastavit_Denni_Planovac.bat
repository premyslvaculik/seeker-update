...
echo spusteni kontroly kazdy den v 17:00 na pozadi.
echo.

schtasks /create /tn "UpdateSeekerDailyCheck" /tr "wscript.exe \"%~dp0Spustit_Na_Pozadi.vbs\"" /sc daily /st 17:00 /f

if %errorlevel% equ 0 (
    echo.
    echo [OK] Uloha byla uspesne pridana do Planovace uloh ve Windows!
    echo Kontrola probehne automaticky kazdy den v 17:00 na pozadi.
) else (
    echo.
